...
export const tracks: Track[] = [
  {
    ...
    albumFa: 'تک‌آهنگ',
    releaseDate: '2024',
    imageUrl: '/static/images/alda.jpeg',
  ...
  {
    id: '10',
    title: 'Trapshit (Prod. Ashkanmadz)',
    titleFa: 'ترپ شت',
    artist: 'ALDA',
    album: 'Single',
    albumFa: 'تک‌آهنگ',
    releaseDate: '2024',
    imageUrl: '/static/images/alda.jpeg',
    audioUrl: '/static/music/Alda - Trapshit (Prod Ashkanmadz).mp3',
    driveDownloadUrl: '/static/music/Alda - Trapshit (Prod Ashkanmadz).mp3',
    duration: '2:56',
  },
  {
    id: '11',
    title: 'Siah (Prod. Ashkanmadz)',
    titleFa: 'سیاه',
    artist: 'ALDA',
    album: 'Single',
    albumFa: 'تک‌آهنگ',
    releaseDate: '2024',
    imageUrl: '/static/images/alda.jpeg',
    audioUrl: '/static/music/Siah (Prod Ashkanmadz).mp3',
    driveDownloadUrl: '/static/music/Siah (Prod Ashkanmadz).mp3',
    duration: '2:56',
  },
]
